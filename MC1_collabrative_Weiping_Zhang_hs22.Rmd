---
title: "Collaborative Movie Recommender by Weiping Zhang, HS22" 
output:
  html_document:
    toc: yes
    toc_depth: '4'
...
- Erzeuge einen IBCF Recommender und analysiere die Ähnlichkeitsmatrix des trainierten Modelles für den reduzierten Datensatz.
...
- um (a) für ordinale Ratings effizient die Cosine Similarity und (b) für binäre Ratings effizient die Jaccard Similarity zu berechnen
#### 4.1a Implementiere eine Funktion,

- um für ordinale Ratings effizient die Cosine Similarity zu berechnen,
...
- Vergleiche deine Implementierung der Cosine-basierten Ähnlichkeitsmatrix für ordinale Kundenratings mit der korrespondierenden via Open Source Paketen erzeugten Ähnlichkeitsmatrix,
...
- Vergleiche und diskutiere die Unterschiede deiner mittels Cosine Similarity erzeugten Ähnlichkeitsmatrizen für ordinale und normierte Kundenratings mit der Jaccard-basierten Ähnlichkeitsmatrix.
...
#### 9.2 Begründe meine Wahl der Performance Metrik,
